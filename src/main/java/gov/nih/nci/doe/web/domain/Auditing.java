...
public class Auditing {
	...
	public String toString() {
		return "Consortium{" + ", id='" + id + '\'' + ", name=" + name + ", path=" + path + ", operation=" + operation
				+ ", status=" + status + ", errorMsg=" + errorMsg + ", taskId=" + taskId + ", transferType="
				+ transferType + ", startTime=" + startTime + ", completionTime=" + completionTime + '}';
	}
}
