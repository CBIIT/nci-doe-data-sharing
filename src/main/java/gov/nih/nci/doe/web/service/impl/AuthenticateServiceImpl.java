...
public class AuthenticateServiceImpl implements AuthenticateService {
	...
	public LoginStatusCode authenticateExternalUser(final String username, final String password) {
		try {
			...
			// check to see if the password user entered matches the one stored in the system
	...
	private LoginStatusCode checkForPassword(final String username, final boolean passwordMatched)
			throws Exception {
		LoginStatusCode status =null;		
		if(passwordMatched) {
